module.exports = {
	...
	onlyadminbox: {
		description: "only admin box can use bot",
		guide: " {pn} [on: off]",
		text: {
			turnedOn: "On: only admin of group can use bot",
			turnedOff: "Off: only admin of group can use bot",
			syntaxError: "Error, use {pn} on or {pn} off"
		}
	},
	adduser: {
		...
		text: {
			...
			invalidLink: "Enter a valid facebook link",
			cannotGetUid: "Cannot get uid of this user",
			linkNotExist: "This profile url doesn't exist",
	...
	adminonly: {
		...
		guide: "{pn} [on: off]",
		text: {
			turnedOn: "On: only admin can use bot",
			turnedOff: "Off: only admin can use bot",
			syntaxError: "Error, use {pn} on or {pn} off"
		}
	},
	all: {
		description: "Tag all members chat",
	...
	antichangeinfobox: {
		description: "anti change info box",
		...
		text: {
			antiChangeAvatarOn: "On: anti change avatar box chat",
			antiChangeAvatarOff: "Off: anti change avatar box chat",
			missingAvt: "You have not set avatar for box chat",
			antiChangeNameOn: "On: anti change name box chat",
			antiChangeNameOff: "Off: anti change name box chat",
			antiChangeThemeOn: "On: anti change theme box chat",
			antiChangeThemeOff: "Off: anti change theme box chat",
			antiChangeEmojiOn: "On: anti change emoji box chat",
			antiChangeEmojiOff: "Off: anti change emoji box chat",
			antiChangeAvatarAlreadyOn: "Your box chat on anti change avatar",
			antiChangeNameAlreadyOn: "Your box chat on anti change name",
			antiChangeThemeAlreadyOn: "Your box chat on anti change theme",
			antiChangeEmojiAlreadyOn: "Your box chat on anti change emoji"
		}
	},
	appstore: {
	...
	autosetname: {
		...
		text: {
			...
			error: "Error while using the autoSetName feature, try turning off the invite link feature and try again later"
		}
	},
	avatar: {
		...
		text: {
			...
			errorGetCharacter: "Error while getting character data:\n%1: %2",
			success: "✓ Your avatar\nCharacter: %1\nID: %2\nBackground text: %3\nSignature: %4\nColor: %5",
	...
	badwords: {
		...
		text: {
			...
			missingWords: "!: Missing the banned words",
			addedSuccess: "✓: Added %1 banned words to the list",
			alreadyExist: "×: %1 banned words exist in the list before: %2",
			tooShort: "!: %1 banned words can't be added to the list because they are shorter than 2 characters: %2",
			onlyAdmin2: "!: Only admins can delete banned words from the list",
			missingWords2: "!: Missing the words to delete",
			deletedSuccess: "✓: Deleted %1 banned words from the list",
			notExist: "×: %1 banned words don't exist in the list before: %2",
			emptyList: "!: The list of banned words empty",
			badWordsList: ": The list of banned words: %1",
			onlyAdmin3: "!: Only admins can %1 this feature",
			turnedOnOrOff: "✓: Banned words warning %1",
			onlyAdmin4: "!: Only admins can delete banned words warning",
			missingTarget: "!: Missing user ID or tagged user",
			notWarned: "!: User %1 has not been warned for banned words",
			removedWarn: "✓: User %1: %2 removed 1 banned words warning",
			warned: "!: Banned words \"%1\" detected in your message, if you continue to violate you will be kicked from the group.",
			warned2: "!: Banned words \"%1\" detected in your message, you have violated 2 times and will be kicked from the group.",
	...
	batslap: {
		...
		text: {
			noTag: "Must tag the person you want to slap"
		}
	},
	busy: {
		description: "turn on don't disturb mode, when you are tagged bot will notify",
		guide: " {pn} [empty: <reason>]: turn on don't disturb mode\n {pn} off: turn off don't disturb mode",
		text: {
			turnedOff: "✓: Do not disturb mode turned off",
			turnedOn: "✓: Do not disturb mode turned on",
			turnedOnWithReason: "✓: Do not disturb mode turned on reason:: %1",
			alreadyOn: "User %1 busy",
			alreadyOnWithReason: "User %1 busy reason:: %2"
		}
	},
	callad: {
		...
		guide: " {pn} <message>",
		text: {
			missingMessage: "Enter the message you want to send to admin",
			sendByGroup: "\n- Sent from group: %1\n- Thread ID: %2",
			sendByUser: "\n- Sent from user",
			content: "\n\nContent:\n─────────────────\n%1\n─────────────────\nReply to send message to user",
			success: "Sent your message to admin !",
			reply: "> Reply from admin %1:\n─────────────────\n%2\n─────────────────\nReply to continue send message to admin",
			replySuccess: "Sent your reply to admin !",
			feedback: " Feedback from user %1:\n- User ID: %2%3\n\nContent:\n─────────────────\n%4\n─────────────────\nReply to send message to user",
			replyUserSuccess: "Sent your reply to user !"
		}
	},
	cmd: {
		...
		text: {
			missingFileName: "! Enter the command name you want to reload",
			loaded: "✓ Loaded command \"%1\" ",
			loadedError: "× Failed to load command \"%1\" error:\n%2: %3",
			loadedSuccess: "✓ Loaded \"%1\" command",
			loadedFail: "× Failed to load \"%1\" command\n%2",
			missingCommandNameUnload: "! Enter the command name you want to unload",
			unloaded: "✓ Unloaded command \"%1\" ",
			unloadedError: "× Failed to unload command \"%1\" error:\n%2: %3",
			missingUrlCodeOrFileName: "! Enter the url or code and command file name you want to install",
			missingUrlOrCode: "! Enter the url or code of the command file you want to install",
			missingFileNameInstall: "! Enter the file name to save the command (with .js extension)",
			invalidUrlOrCode: "! Unable to get command code",
			alreadExist: "! Command file exists, are you sure you want to overwrite the old command file?\nReact to continue",
			installed: "✓ Installed command \"%1\" , the command file is saved at %2",
			installedError: "× Failed to install command \"%1\" error:\n%2: %3",
	...
	count: {
		...
		text: {
			...
			endMessage: "Those who don't have a name in the list have not sent any messages.",
			page: "Page [%1/%2]",
	...
	customrankcard: {
		...
		text: {
			...
			invalidAlpha: "choose a number from 0 -> 1"
		}
	},
	dhbc: {
	...
	event: {
		...
		text: {
			missingFileName: "!: Enter the command name you want to reload",
			loaded: "✓: Loaded event command \"%1\" ",
			loadedError: "×: Loaded event command \"%1\" failed error:\n%2: %3",
			loadedSuccess: "✓: Loaded \"%1\" event command ",
			loadedFail: "×: Loaded event command \"%1\" failed\n%2",
			missingCommandNameUnload: "!: Enter the command name you want to unload",
			unloaded: "✓: Unloaded event command \"%1\" ",
			unloadedError: "×: Unloaded event command \"%1\" failed error:\n%2: %3",
			missingUrlCodeOrFileName: "!: Enter the url or code and command file name you want to install",
			missingUrlOrCode: "!: Enter the url or code of the command file you want to install",
			missingFileNameInstall: "!: Enter the file name to save the command (with .js extension)",
			invalidUrlOrCode: "!: Unable to get command code",
			alreadExist: "!: Command file exists, are you sure you want to overwrite the old command file?\nReact to continue",
			installed: "✓: Installed event command \"%1\" , the command file is saved at %2",
			installedError: "×: Installed event command \"%1\" failed error:\n%2: %3",
	...
	filteruser: {
		...
		text: {
			needAdmin: "!: add the bot as a group admin to use this command",
			confirm: "!: Are you sure you want to delete group members with less than %1 messages?\nReact to confirm",
			kickByBlock: "✓: deleted %1 members who are locked acc",
			kickByMsg: "✓: deleted %1 members with less than %2 messages",
			kickError: "×: Error and could not kick %1 members:\n%2",
	...
	grouptag: {
		...
		text: {
			...
			existedInGroupTag: "Members:\n%1\nexisted in group tag \"%2\"",
			notExistedInGroupTag: "Members:\n%1\ndoesn't exist in group tag \"%2\"",
			noExistedGroupTag: "Group tag \"%1\" doesn't exist chat",
			noExistedGroupTag2: "Group chat hasn't added any group tag",
			noMentionDel: "tag members to remove from group tag \"%1\"",
	...
	help: {
		...
		text: {
			...
			commandNotFound: "Command \"%1\" doesn't exist",
			...
			pageNotFound: "Page %1 doesn't exist"
		}
	},
	kick: {
	...
	moon: {
		...
		text: {
			invalidDateFormat: "Enter a valid date in DD/MM/YYYY format",
			error: "Error while getting the moon image of %1",
	...
	notification: {
		...
		guide: "{pn} <tin nhắn>",
		text: {
			missingMessage: "Enter the message you want to send to all groups",
			notification: "Notification from admin bot to all chat groups (don't reply to this message)",
	...
	prefix: {
		...
		text: {
			...
			confirmGlobal: "react to this message to confirm change prefix of system bot",
			confirmThisThread: "react to this message to confirm change prefix in your box chat",
	...
	setalias: {
		description: "Add an alias for any command",
		guide: " This command is used to add/remove alias for any command\n {pn} add <alias> <command>: add an alias for the command\n {pn} add <alias> <command> -g: add an alias for the command in the whole system (only bot admin)\nExample:\n {pn} add ctrk customrankcard\n\n {pn} [remove: rm] <alias> <command>: remove an alias for the command\n {pn} [remove: rm] <alias> <command> -g: remove an alias for the command in the whole system (only bot admin)\nExample:\n {pn} rm ctrk customrankcard\n\n {pn} list: list all alias for commands\n {pn} list -g: list all alias for commands in the whole system"
	},
	setavt: {
		description: "Change bot avatar",
		text: {
			cannotGetImage: "×: Error while querying the image url",
			invalidImageFormat: "×: Invalid image format",
			changedAvatar: "✓: Changed bot avatar "
		}
	},
	setlang: {
	...
	setleave: {
		...
		text: {
			...
			missingFile: "reply this message with image/video/audio file",
	...
	setname: {
		...
		text: {
			error: "An error has occurred, try turning off the invite link feature and try again later"
		}
	},
	setrole: {
		...
		text: {
			noEditedCommand: "✓ Group has no edited command",
			editedCommand: "! Group has edited commands:\n",
	...
	setwelcome: {
		description: "Edit welcome message content when new member join group chat",
		guide: {
		...
		text: {
			...
			missingFile: "reply this message with image/video/audio file",
			addedFile: "Added %1 file attachments to group welcome message"
		}
	},
	shortcut: {
		...
		text: {
			...
			shortcutExists: 'Shortcut "%1" exists, react to this message to replace the content of the shortcut',
	...
	thread: {
		...
		text: {
			...
			hasBanned: "Group with id [%1: %2] banned before:\n» Reason: %3\n» Time: %4",
			...
			missingReason: "Ban reason can't be empty",
			info: "» Box ID: %1\n» Name: %2\n» Date created data: %3\n» Total members: %4\n» Boy: %5 members\n» Girl: %6 members\n» Total messages: %7%8"
		}
	},
	tid: {
		description: "View threadID chat",
		guide: "{pn}"
	},
	tik: {
		...
		text: {
			invalidUrl: "Enter a valid tiktok url",
	...
	uid: {
		...
		text: {
			syntaxError: "tag the person you want to view uid or leave it blank to view your own uid"
		}
	},
	unsend: {
		...
		text: {
			syntaxError: "reply the message you want to unsend"
		}
	},
	user: {
		...
		text: {
			...
			uidRequired: "Uid of user to ban can't be empty, please enter uid or tag or reply message of 1 user by user ban <uid> <reason>",
			reasonRequired: "Reason to ban user can't be empty, please enter uid or tag or reply message of 1 user by user ban <uid> <reason>",
			userHasBanned: "User with id [%1: %2] banned before:\n» Reason: %3\n» Date: %4",
			userBanned: "User with id [%1: %2] banned:\n» Reason: %3\n» Date: %4",
			uidRequiredUnban: "Uid of user to unban can't be empty",
	...
	videofb: {
		...
		text: {
			missingUrl: "Enter the facebook video/story (public) url you want to download",
			error: "Error while downloading the video",
	...
	warn: {
		...
		guide: " {pn} @tag <reason>: warn member\n {pn} list: view list of warned members\n {pn} listban: view list of banned members\n {pn} info [@tag: <uid>: leave blank]: view warn info of tagged member or uid or yourself\n {pn} unban <uid>: unban member by uid\n {pn} unwarn <uid> [<warn number>: leave blank]: unwarn member by uid and warn number\n {pn} warn reset: reset all warn data\n! Need to set admin for bot to auto kick banned members",
		text: {
			list: "List of members who warned:\n%1\n\nTo view the details of the warnings, use the \"%2warn info [@tag: <uid>: leave blank]\" command: to view the warning information of the tagged person or uid or yourself",
			listBan: "List of members who warned 3 times and banned from the box:\n%1",
			listEmpty: "Group has no members who warned",
			listBanEmpty: "Group has no members banned from the box",
			invalidUid: "Enter a valid uid of the person you want to view information",
			noData: "No data",
			noPermission: "× Only group administrators can unban members banned from the box",
			invalidUid2: "! Enter a valid uid of the person you want to unban",
			notBanned: "! The user with id %1 has not been banned from your box",
			unbanSuccess: "✓ unbanned member [%1: %2], currently this person can join your chat box",
			noPermission2: "× Only group administrators can remove warnings from members",
			invalidUid3: "! Enter a uid or tag the person you want to remove the warning",
			noData2: "! The user with id %1 has no warning data",
			notEnoughWarn: "× The user %1 only has %2 warnings",
			unwarnSuccess: "✓ removed the %1 warning of member [%2: %3]",
			noPermission3: "× Only group administrators can reset warning data",
			resetWarnSuccess: "✓ reset warning data",
			noPermission4: "× Only group administrators can warn members",
			invalidUid4: "! Need to tag or reply to the message of the person you want to warn",
			warnSuccess: "! Warned member %1 times %2\n- Uid: %3\n- Reason: %4\n- Date Time: %5\nThis member warned 3 times and banned from the box, to unban use the command \"%6warn unban <uid>\" (with uid is the uid of the person you want to unban)",
			noPermission5: "! Bot needs administrator permissions to kick banned members",
			warnSuccess2: "! Warned member %1 times %2\n- Uid: %3\n- Reason: %4\n- Date Time: %5\nIf this person violates %6 more times, they will be banned from the box",
			hasBanned: "! The following members warned 3 times before and banned from the box:\n%1",
			failedKick: "! Error when kicking the following members:\n%1"
		}
	},
	weather: {
