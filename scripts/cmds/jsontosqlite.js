...
module.exports = {
	...
	langs: {
		...
		en: {
			...
			successThread: "✓ synchronized thread data from json to sqlite!",
			successUser: "✓ synchronized user data from json to sqlite!",
			successDashboard: "✓ synchronized dashboard data from json to sqlite!",
			successGlobal: "✓ synchronized global data from json to sqlite!"
		}
	},
