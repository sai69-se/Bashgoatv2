...
module.exports = {
	...
	langs: {
		...
		en: {
			...
			existedBan: "×: This person banned before!",
			noReason: "No reason",
			...
			content: "%1/ %2 (%3)\nReason: %4\nBan time: %5\n\n",
			needAdminToKick: "!: Member %1 (%2) banned from box chat, but the bot does not have administrator permission to kick this member, please grant administrator permission to the bot to kick this member",
			bannedKick: "!: %1 banned from box chat before!\nUID: %2\nReason: %3\nBan time: %4\n\nBot has automatically kicked this member"
		}
	},
