...
module.exports = {
	...
	langs: {
		vi: {
			...
			win: "*_*: Chúc mừng bạn đã đoán đúng số %1 sau %2 lần đoán và nhận được %3 điểm thưởng.",
		...
		en: {
			...
			digits: "%1 digits: %2",
			resetRankSuccess: "✓: Reset the ranking .",
			invalidCol: "!: Enter the number of digits of the number to guess is 4, 5 or 6",
			invalidMode: "!: Enter the game mode is single or multi",
			created: "✓: Create game .",
			...
			invalidNumbers: "!: Enter %1 numbers you want to guess",
			win: "*_*: Congratulations you guessed the number %1 after %2 guesses and received %3 bonus points.",
