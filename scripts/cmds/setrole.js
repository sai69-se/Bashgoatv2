module.exports = {
        config: {
                ...
                role: 1,
                description: {
                        vi: "Chỉnh sửa role của lệnh (Developer có thể sửa tất cả)",
                        en: "Edit role of command (Developers can edit all commands)"
                },
                category: "info",
                guide: {
        ...
        langs: {
                vi: {
                        ...
                        noChangeRole: "❗ Không thể thay đổi role của lệnh \"%1\" (Chỉ Developer mới có quyền)",
                ...
                en: {
                        ...
                        noChangeRole: "❗ Can't change role of command \"%1\" (Only Developers have permission)",
        ...
        onStart: async function ({ message, event, args, role, threadsData, getLang }) {
                ...
                if (command.config.role > 1 && role < 4)
